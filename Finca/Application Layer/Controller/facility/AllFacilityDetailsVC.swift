...
class AllFacilityDetailsVC: BaseVC {
            ...
            if json != nil {
                ...
                do {
                    ...
                    if response.status == "200" {
                        ...
                        self.responseFacilityDetails = response
                        ...
                        self.lbAmount.text = "Facility Amount : " + StringConstants.RUPEE_SYMBOL + response.facility_amount + " / Per Person/Per Month"
                         ...
                         self.lbCount.text = "Person Count : " + response.person_count
    ...
    @IBAction func onClickBook(_ sender: Any) {
        let vc = self.storyboard?.instantiateViewController(withIdentifier: "idDailogFacilityBookVC") as! DailogFacilityBookVC
       vc.responseFacilityDetails = responseFacilityDetails
