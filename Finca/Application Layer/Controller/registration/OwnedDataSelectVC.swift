...
class OwnedDataSelectVC: BaseVC,UIImagePickerControllerDelegate,UINavigationControllerDelegate {
    ...
    @IBOutlet weak var bAddMember: UIButton!
      @IBOutlet weak var bAddNumber: UIButton!
    ...
    override func viewDidLoad() {
        ...
        changeButtonImageColor(btn: bBack, image: "back", color: UIColor.white)
         changeButtonImageColor(btn: bAddNumber, image: "add-button-inside-black-circle", color: UIColor(named: "ColorPrimary")!)
        changeButtonImageColor(btn: bAddMember, image: "add-button-inside-black-circle", color: UIColor(named: "ColorPrimary")!)
